            ...
            <form className="mt-6">
              ...
              <div className="flex-1 mt-6">
                ...
                >
                  ...
                  <option value="dog">Site marchand</option>
                  <option value="dog">Application mobile</option>
                  <option value="cat">Développement spécifique</option>
                  <option value="cat">Audit / Conseil</option>
                  <option value="hamster">Référencement</option>
              ...
              <div className="flex-1 mt-6">
                ...
                >
                  <input
                    id="showcase-site"
                    type="checkbox"
                    className="block cursor-pointer w-4 h-4 bg-white border focus:border-violet-400 focus:ring-violet-300 focus:ring-opacity-40 focus:outline-none focus:ring"
                  />
                  <span className="ml-2">Site vitrine</span>
                </label>
              </div>
              ...
              <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-violet-400 rounded-md hover:bg-violet-500 focus:outline-none focus:ring focus:ring-violet-400 focus:ring-opacity-50">
                Envoyer
              </button>
            </form>
          </div>
